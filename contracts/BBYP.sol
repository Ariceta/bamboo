...
contract BBYP is Ownable{
    ...
    constructor(BambooToken _bamboo) public {
        bamboo = _bamboo;
        isActive = false;
    }
    ...
    function commit() public {
        ...
        if(participants.length < 1){
            purchaseLimit = block.timestamp.add(31536000);
    ...
    // Deposits bamboo to the prize pool. This will come from the BAMBOOVAULT wallet.
    function addToPool(uint256 _amount) external onlyOwner {
